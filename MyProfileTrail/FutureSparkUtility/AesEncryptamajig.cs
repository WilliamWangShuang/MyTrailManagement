...
namespace MyProfileTrail.FutureSparkUtility
{
    ...
    /// Ref: https://github.com/jbubriski/Encryptamajig
    /// </summary>
    public class AesEncryptamajig
    {
        ...
        {
            string filePath = HostingEnvironment.ApplicationPhysicalPath + "/FutureSparkUtility/Key.dat";
            ...
            {
                throw new FileNotFoundException(ErrorMessage.KeyFileNotFound);
            }
            return key;
        }
